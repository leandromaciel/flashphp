 ...
 *---------------------------------------------------------------
 *
 * Here you set where the Entity Objects will be placed with the trailing slash "/"
 *
 */
define('ENTITY_PATH', '../../src/Entity/');
 ...
 *
 */
define('PROXY_PATH', ENTITY_PATH.'Proxies/');
 ...
 *---------------------------------------------------------------
 *
 * Here you set where the Singletons for your APPLICATION will be placed with the trailing slash "/"
 *
 */
define('SINGLETON_PATH', '../../src/Singleton/'.APPLICATION.'/');
